export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	togepi: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 55, atk: 20, def: 85, spa: 40, spd: 65, spe: 20},
	...
	togetic: {
		...
		types: ["Fairy", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 85, atk: 40, def: 105, spa: 80, spd: 110, spe: 40},
		abilities: {0: "Natural Cure", 1: "Serene Grace", H: "Super Luck", S: "Pixelate"},
		heightm: 0.6,
		weightkg: 3.2,
		color: "White",
		prevo: "Togepi",
