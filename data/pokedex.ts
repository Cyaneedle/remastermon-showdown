export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	raticate: {
		...
		abilities: {0: "Quick Feet", 1: "Guts", H: "Hustle", S: "Strong Jaw"},
		heightm: 0.7,
		weightkg: 18.5,
		color: "Brown",
		prevo: "Rattata",
	...
	arbok: {
		...
		name: "Arbok",
		types: ["Poison", "Ground"],
		baseStats: {hp: 105, atk: 95, def: 86, spa: 65, spd: 79, spe: 80},
	...
	sandslashalola: {
		...
		forme: "Alola",
		types: ["Ice", "Steel"],
		baseStats: {hp: 75, atk: 100, def: 135, spa: 25, spd: 65, spe: 68},
		abilities: {0: "Rough Skin", H: "Ice Body", S: "Slush Rush"},
		heightm: 1.2,
		weightkg: 55,
		color: "Blue",
