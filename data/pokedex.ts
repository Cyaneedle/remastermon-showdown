export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	arbok: {
		...
		name: "Arbok",
		types: ["Poison", "Ground"],
		baseStats: {hp: 125, atk: 105, def: 96, spa: 79, spd: 79, spe: 80},
	...
	pikachuhoenn: {
		...
		gender: "M",
		baseStats: {hp: 35, atk: 55, def: 40, spa: 55, spd: 50, spe: 90},
		abilities: {0: "Static", H: "Lightning Rod", S: "Water Bubble"},
		heightm: 0.4,
		weightkg: 6,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	nidoqueen: {
		...
		types: ["Poison", "Ground"],
		gender: "F",
		baseStats: {hp: 110, atk: 92, def: 110, spa: 75, spd: 110, spe: 76},
	...
	nidoking: {
		...
		types: ["Poison", "Ground"],
		gender: "M",
		baseStats: {hp: 81, atk: 112, def: 77, spa: 105, spd: 75, spe: 110},
	...
	clefable: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 110, atk: 70, def: 95, spa: 95, spd: 105, spe: 60},
	...
	dugtrioalola: {
		...
		forme: "Alola",
		types: ["Ground", "Steel"],
		baseStats: {hp: 80, atk: 100, def: 110, spa: 50, spd: 115, spe: 60},
